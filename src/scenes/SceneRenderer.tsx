...
import { BrowserWindow, NotificationCard, AppGrid, Checklist, ProgressBar, TerminalTyping, CursorClick, OfferDashboard, PaymentCollision, PricingDashboard, InfographicPreset, PaymentWarning, ExchangeRateChart } from "../components/ui/UiComponents";
...
function renderClip(clip: CompiledClip, job: MotionRenderJob): React.ReactNode {
  switch (clip.kind) {
    ...
    case "ui.offerDashboard": return <OfferDashboard {...propsOf<Parameters<typeof OfferDashboard>[0]>(clip)} />;
    case "ui.paymentCollision": return <PaymentCollision {...propsOf<Parameters<typeof PaymentCollision>[0]>(clip)} />;
